...
<html lang="en" dir="ltr">
  ...
  <body>
    <?php
          ...
          $sql = "INSERT INTO Table_Name (name, roll, branch, gender, email, phone, residence, username, password, cur_datetime) VALUES ('$name', '$roll', '$branch','$gender', '$email', '$phone', '$place', '$uname', '$pword', now())";
    ...
    ?>
    <h1> Thank You!!<h1>
    <p> Your response has been recorded. Please follow our facebook page to stay updated with the latest news. </p>
